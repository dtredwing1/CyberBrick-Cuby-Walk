...
# Clean baseline walking code (no deduplication hacks)
...
for channel in data['sender']['channels']:
    ...
    # Remove L Shoulder Button completely
...
data['config_name'] = "CUBY_V1.9_Baseline"

with open('c:/Users/mott_/OneDrive/Documents/CyberBrick/Cuby/CUBY_walk_turn.json', 'w') as f:
    json.dump(data, f, separators=(',', ':'))

print("Generated CUBY_walk_turn.json with V1.9 Clean Baseline!")
