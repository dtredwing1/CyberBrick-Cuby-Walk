...
# ==========================================
# V1.12: THE TOTAL LOCKDOWN (Ignition Key)
# ==========================================
...
for channel in data['sender']['channels']:
    ...
    # Disable the L Shoulder Button to prevent I2C Contention / Thread Assassination
    if channel.get('name') == 'L Shoulder Button':
        channel['event'] = []

    # Map CODE to L Shoulder 3-Pos switch (UP to turn on, DOWN to cleanly kill)
...
data['config_name'] = "CUBY_V1.12_TotalLockdown"

with open('c:/Users/mott_/OneDrive/Documents/CyberBrick/Cuby/CUBY_walk_turn.json', 'w') as f:
    json.dump(data, f, separators=(',', ':'))

print("Generated CUBY_walk_turn.json with V1.12 Total Lockdown!")
